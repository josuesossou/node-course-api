...
//you can use .findById to querry by the id of the object -- returns the object that has the id (this one is specific to id property, in case the id null or underfind this one will not work)
